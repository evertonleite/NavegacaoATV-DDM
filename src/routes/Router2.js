...
export function Routes() {
    return (
        <BottomTab.Navigator tabBarOptions={  {style: {backgroundColor: '#3CB371', height: 60} ,labelPosition: 'below-icon', activeTintColor: '#7FFFD4', labelStyle: {fontSize: 15, fontWeight: '700', top: -5}, inactiveTintColor: 'white'}}>
